...
void Refresh_Every_Second_Task(void *params)
{
	
	ESP_LOGI(TAG, "Now in Refresh_Every_Second_Task task");
...
void app_main(void)
{
	...
	xTaskCreate(&Refresh_Every_Second_Task, "Refresh_Every_Second_Task", 2048, NULL, 1, NULL);
	ESP_LOGI(TAG, "Created Refresh_Every_Second_Task");
